{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 906.0, 450.0, 872.0, 839.0 ],
		"bglocked" : 0,
		"defrect" : [ 906.0, 450.0, 872.0, 839.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 397.0, 464.0, 155.0, 34.0 ],
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"id" : "obj-48",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b s",
					"patching_rect" : [ 312.0, 461.0, 82.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"patching_rect" : [ 380.0, 647.0, 20.0, 20.0 ],
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"id" : "obj-50"
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 312.0, 501.0, 97.0, 18.0 ],
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "read",
					"patching_rect" : [ 311.0, 565.0, 35.0, 18.0 ],
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "zl join",
					"patching_rect" : [ 311.0, 593.0, 49.0, 20.0 ],
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "buffer~ samp2",
					"patching_rect" : [ 311.0, 619.0, 88.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"patching_rect" : [ 452.0, 206.0, 20.0, 20.0 ],
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"id" : "obj-44",
					"presentation_rect" : [ 452.0, 206.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 452.0, 232.0, 50.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"id" : "obj-45",
					"fontname" : "Arial",
					"presentation_rect" : [ 452.0, 232.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sig~",
					"patching_rect" : [ 525.0, 219.0, 33.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"id" : "obj-46",
					"fontname" : "Arial",
					"presentation_rect" : [ 525.0, 219.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "groove~ samp2",
					"patching_rect" : [ 491.0, 275.0, 94.0, 20.0 ],
					"numinlets" : 3,
					"fontsize" : 12.0,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "route BUZZ BANJO",
					"patching_rect" : [ 363.0, 119.0, 116.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "no full path and extension. Just filename as soundID",
					"linecount" : 2,
					"patching_rect" : [ 207.0, 161.0, 155.0, 34.0 ],
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"id" : "obj-42",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b s",
					"patching_rect" : [ 122.0, 158.0, 82.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 59.0, 672.0, 144.0, 20.0 ],
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"id" : "obj-32",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "bassPop.wav",
					"patching_rect" : [ 122.0, 198.0, 82.0, 18.0 ],
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 321.5, 548.5, 350.5, 548.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 131.5, 245.5, 160.5, 245.5 ]
				}
